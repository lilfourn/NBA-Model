...
const chartConfig = {
  ensemble_hit_rate: { label: "Ensemble", color: "hsl(var(--chart-5))" },
  p_forecast_cal_hit_rate: { label: "Forecast", color: "hsl(var(--chart-1))" },
  p_nn_hit_rate: { label: "NN", color: "hsl(var(--chart-2))" },
  p_lr_hit_rate: { label: "LR", color: "hsl(var(--chart-3))" },
  p_xgb_hit_rate: { label: "XGB", color: "hsl(var(--chart-4))" },
      ...
      <CardContent>
        ...
        <ChartContainer config={chartConfig} className="min-h-[300px] w-full">
          <LineChart data={chartData} accessibilityLayer margin={{ top: 5, right: 12, bottom: 5, left: 0 }}>
            ...
            <ReferenceLine y={50} strokeDasharray="6 3" />
            <Line
              type="natural"
